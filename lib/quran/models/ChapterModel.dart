...
class ChapterModel with LoggerHelper {
  ChapterModel({
...
ChapterModel copyWith({  List<Chapters>? chapters,
}) => ChapterModel(  chapters: chapters ?? _chapters,
);
...
class Chapters {
  Chapters({
    ...
    _id = id;
    _revelationPlace = revelationPlace;
    _revelationOrder = revelationOrder;
    _bismillahPre = bismillahPre;
    _nameSimple = nameSimple;
  ...
  Chapters.fromJson(dynamic json) {
    _id = json['id'];
    _revelationPlace = json['revelation_place'];
    _revelationOrder = json['revelation_order'];
    _bismillahPre = json['bismillah_pre'];
    _nameSimple = json['name_simple'];
    _nameComplex = json['name_complex'];
    _nameArabic = json['name_arabic'];
    _versesCount = json['verses_count'];
    _pages = json['pages'] != null ? json['pages'].cast<num>() : [];
    _translatedName = json['translated_name'] != null ? TranslatedName.fromJson(json['translated_name']) : null;
  }
  num? _id;
  String? _revelationPlace;
  num? _revelationOrder;
  bool? _bismillahPre;
  String? _nameSimple;
  String? _nameComplex;
  String? _nameArabic;
...
Chapters copyWith({  num? id,
  ...
  revelationPlace: revelationPlace ?? _revelationPlace,
  revelationOrder: revelationOrder ?? _revelationOrder,
  bismillahPre: bismillahPre ?? _bismillahPre,
  nameSimple: nameSimple ?? _nameSimple,
  nameComplex: nameComplex ?? _nameComplex,
  ...
  num? get id => _id;
  String? get revelationPlace => _revelationPlace;
  num? get revelationOrder => _revelationOrder;
  bool? get bismillahPre => _bismillahPre;
  String? get nameSimple => _nameSimple;
  String? get nameComplex => _nameComplex;
  String? get nameArabic => _nameArabic;
  num? get versesCount => _versesCount;
  List<num>? get pages => _pages;
  TranslatedName? get translatedName => _translatedName;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['id'] = _id;
    map['revelation_place'] = _revelationPlace;
    map['revelation_order'] = _revelationOrder;
    map['bismillah_pre'] = _bismillahPre;
    map['name_simple'] = _nameSimple;
    map['name_complex'] = _nameComplex;
...
class TranslatedName {
  ...
  String? _name;
TranslatedName copyWith({  String? languageName,
  String? name,
}) => TranslatedName(  languageName: languageName ?? _languageName,
  name: name ?? _name,
);
